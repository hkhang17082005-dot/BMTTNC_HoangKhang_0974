...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_gen_keys.setGeometry(QtCore.QRect(360, 20, 91, 19))
        self.btn_gen_keys.setObjectName("btn_gen_keys")
        self.txt_sign = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_sign.setGeometry(QtCore.QRect(170, 170, 391, 91))
        self.txt_sign.setObjectName("txt_sign")
        self.txt_info = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_info.setGeometry(QtCore.QRect(170, 60, 391, 91))
        self.txt_info.setObjectName("txt_info")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(50, 170, 81, 16))
        ...
        self.btn_sign.setGeometry(QtCore.QRect(180, 280, 81, 19))
        self.btn_sign.setObjectName("btn_sign")
        self.btn_verify = QtWidgets.QToolButton(self.centralwidget)
        self.btn_verify.setGeometry(QtCore.QRect(360, 280, 81, 19))
